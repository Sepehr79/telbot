...
public class QueueProcessingRouteBuilder extends AbstractRouteBuilder {
    ...
    public void configureOtherRoutes() {
        from("timer:queue?period=500")
                .choice()
                .when(exchange -> queueService.peekVoiceToTextModel() != null)
                    .to("log:incomeQueue")
                    .process(exchange -> {
                    ...
                    .process(exchange -> {
                        ...
                        if (status.equals("succeeded") && queueService.peekVoiceToTextModel() != null) {
                            ...
                            activeChat.setBalance(activeChat.getBalance() - userProperties.getModel().get(activeChat.getUsingModel()).getVoiceCost());
                    ...
                    .choice()
                    .when(exchange -> exchange.getMessage().getBody() instanceof AppIncomingReq)
                        .to("direct:chat")
